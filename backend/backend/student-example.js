...
/**
 * 学员示例程序 - Hands-on Exercise 1
 * 
 * 这个程序演示了学员如何在本地开发程序来调用训练系统的API
 * 程序会收集EC2实例信息并提交到训练系统
 */
...
console.log('🎯 Hands-on Exercise 1 - 学员提交程序');
console.log('=====================================\n');
 ...
 * 提交练习完成数据
 */
async function submitExercise(ec2Info) {
